...
public class RedTeleop extends OpMode {
    ...
    boolean driveFieldRelative = true; //start in Robot Relative Driving mode
    ...
    public void loop() {
        ...
        //Turntable control
        ccwButton = gamepad2.left_bumper;
        cwButton = gamepad2.right_bumper;
        ccwPower = gamepad2.left_trigger;
        cwPower = gamepad2.right_trigger;
